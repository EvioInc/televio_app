...
// 이슈: build.gradle 에 결제 라이브러리 종속 항목 추가했더니 오히려 동작 안함. (thirty 참조) 결제 라이브러리 추가하지 말것(플러터 패키지와 충돌나는 듯)

// 2. 아이폰 https://help.apple.com/app-store-connect/#/devb57be10e7
// xcode에서 인앱결제 추가하기 (링크참조)

// 3. 안드로이드는 코드 대충 넣고 스토어에 '내부테스트'로 업로드부터 빨리 해야함
// -> 심사 기간 있음. 이게 승인되면 구글플레이콘솔에서 인앱결제 상품 생성이 가능함
